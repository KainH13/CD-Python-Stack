...
def number_of_military_branches():
    return 5
print(number_of_days_in_a_week_silicon_or_triangle_sides() + number_of_military_branches()) # name error
...
def number_of_fingers():
    return 5
    print(10)
print(number_of_fingers()) # 5, nothing executed after return
...
def add(b,c):
    print(b+c)
print(add(1,2) + add(2,3)) # 3 5 error for concatenating NoneType
